...
@Stable
class PlayGroundColorScheme(extraColor: Color) {
    var extraColor by mutableStateOf(extraColor, structuralEqualityPolicy())
        internal set
}

fun playGroundLightColorScheme(): PlayGroundColorScheme {
    return PlayGroundColorScheme(extraColor = md_theme_dark_outline)
}

fun playGroundDarkColorScheme(): PlayGroundColorScheme {
    return PlayGroundColorScheme(extraColor = md_theme_dark_outline)
}

val LocalPlayGroundColorScheme = staticCompositionLocalOf { playGroundLightColorScheme() }
